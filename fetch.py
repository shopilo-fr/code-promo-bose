#!/usr/bin/env python3
"""
Recuperation des codes promo Bose depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/bose.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/bose.fr"
STORE_NAME = "Bose"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Bose depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-bose)"
    }
    try:
